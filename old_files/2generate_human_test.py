...
if __name__=='__main__':
    ...
    with open('experiment3.yml') as ymlfile:
    ...
    weights_path = "model/30/keras_model_files.h5"
    ...
    data_experiment = Data_loader_lines(cgf['TEST']['arguments'])
    experiment_data, experiment_labels = data_experiment.load_data3()
    ...
    mistakes_path = join("experiment3","wrong")
